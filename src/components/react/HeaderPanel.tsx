const sourceCodeUrl = "";
const titleText = "Dice Roller and Distribution Calculator";
const githubLink = "https://github.com/tadeohepperle";
    ...
    <div className="hidden sm:flex w-full bg-slate-800 output-shadow p-2 items-center ">
      ...
      <div className="text-white">
        <a href={sourceCodeUrl} className="flex items-center">
          ...
          <div>
            <a href="https://github.com/tadeohepperle/dice-calculator-frontend">
              Source Code
            </a>
          </div>
        </a>
